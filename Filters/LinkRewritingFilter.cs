    ...
    public class LinkRewritingFilter : IAsyncResultFilter
    {
        ...
        private static void RewriteAllLinks(object model, LinkRewriter rewriter)
        {
            ...
            var allProperties = model
                .GetType().GetTypeInfo()
                .GetAllProperties().Where(prop => prop.CanRead).ToArray();
            ...
            RewriteLinksInNestedArrays(arrayProperties, model, rewriter);
        ...
        private static void RewriteLinksInNestedArrays(IEnumerable<PropertyInfo> arrayProperties, object model, LinkRewriter rewriter)
        {
        ...
        private static void RewriteLinksInNestedObjects(IEnumerable<PropertyInfo> objectProperties, object model, LinkRewriter rewriter)
        {
            ...
            {
                if (objectProperty.PropertyType == typeof(string)) continue;
