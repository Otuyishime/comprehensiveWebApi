...
namespace testWebAPI.Models.Resources
{
    public class PagedCollection<T> : Collection<T>
    {
        ...
        public int? Offset { get; set; } // offset from the beginning of the collection

        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public int? Limit { get; set; } // how many elements to return for the current page

        public int Size { get; set; } // total number of elements in the collection
